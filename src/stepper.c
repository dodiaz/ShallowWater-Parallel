                            ...
                            float cfl)
{
    ...
    int t_btwn_com = 1;        //--//--//--// if this is changed, change line at end with same comment structure
    int ng = 4*t_btwn_com;                                                          
                   ...
                   float tfinal, float dx, float dy, float cfl)
{
    ...
    int time_btwn_comm = 1;  //--//--//--// if this is changed, change line at beginning of code with same comment structure
